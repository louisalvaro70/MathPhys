...
public class Ball{
    ...
    private final static double a = 0.0005;
    private Color ballColor;

    public Ball(double positionX, double positionY, double radius, double mass, Color ballColor){
        this.radius = radius;
    ...
    public void ballCollide(ArrayList<Ball> balls){
        for(Ball b: balls){
            if(b != this && this.distance(b) <= this.radius + b.getRadius()){
                ...
                //calculate the unit centre vector
                else{
                    ...
                    //calculate the normal vector of the center vector
                    double NVectorX = -CVectorX;
                    double NVectorY = CVectorX;

                    //projecting the ball's velocity to the centre and normal vector the two balls
                    ...
                    while(this.distance(b) <= (this.radius + b.getRadius())){
                        ...
                        b.setPositionX(b.getPositionY() - b.getVelocityY());
                    }
                }
            }
        }
    ...
    //check collision between walls and the balls
