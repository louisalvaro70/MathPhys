...
/*
	...
	TODO:
     ...
     2. Make more brick targets - done
     3. Increase brick size and lessen gaps among bricks - done
     4. Enlarge ball and change all colors in the game system - done
...
public class UTS {
	...
	public UTS()
	{
		...
		ball = new Ball(0, 0, 0.5, v, v, Color.BLUE);
		...
		for(int i=0; i<ttlPerRow; i++)			
			targets.add(new Block(targetX + i * incX, targetY + i * incY, targetWidth, targetHeight, Color.YELLOW));
