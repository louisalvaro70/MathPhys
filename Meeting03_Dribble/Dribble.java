...
public class Dribble {
    ...
    public Dribble() {
        ...
        balls.add(new Ball(300, 100, 20, 15, -3, Color.green));
        balls.add(new Ball(300, 520, 13, 25, 14, Color.red));
        balls.add(new Ball(300, 350, 50, 7, -5, Color.yellow));
        balls.add(new Ball(300, 205, 35, 8, 6, Color.cyan));
        balls.add(new Ball(300, 150, 64, 15, -9, Color.magenta));
        balls.add(new Ball(300, 275, 45, 25, 24, Color.black));
        balls.add(new Ball(300, 562, 50, 14, -12, Color.orange));
